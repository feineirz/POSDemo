...
/****************************************{{{ CLASS START }}}***************************************/
/**
 * ReceiptDetail class to manage ReceiptDetail in the Database.
 */
...
/*------------------------------------------------------------------------------------------------*/
	...
	/// DEFAULT CONSTRUCTOR ///
	/**
	 * Default ReceiptDetail class to use a private helpful methods.
	 */
	...
	/**
	 * 
	 * @param ReceiptDetail_id A Primary key of ReceiptDetail to be instances.
	 */       
...
/*------------------------------------------------------------------------------------------------*/
	...
	/**
	 * 
	 * Default List method to list all record of ReceiptDetail in the database.
	 * 
	 ...
	 * 
	 * @return ArrayList of ReceiptDetail objects matches to the given condition.
	 * 
	 */
...
/// Private ///
	 ...
	 */
	private boolean deleteReceiptDetail() {
...
/*----------------------------------------[ ToCLASSINFO ]-----------------------------------------*/
/*------------------------------------------------------------------------------------------------*/
/*----------------- Convert ReceiptDetail class to the ReceiptDetailInfo class. ------------------*/
/*------------------------------------------------------------------------------------------------*/
	...
	public ReceiptDetailInfo toReceiptDetailInfo() {
		...
		ci.current_cost = this.current_cost;
		ci.current_price = this.current_price;
