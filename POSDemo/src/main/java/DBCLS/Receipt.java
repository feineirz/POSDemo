...
/****************************************{{{ CLASS START }}}***************************************/
/**
 * Receipt class to manage Receipt in the Database.
 */
...
/*------------------------------------------------------------------------------------------------*/
	...
	/// DEFAULT CONSTRUCTOR ///
	/**
	 * Default Receipt class to use a private helpful methods.
	 */
	public Receipt() {}
	...
	/**
	 * 
	 * @param Receipt_id A Primary key of Receipt to be instances.
	 */       
...
/*------------------------------------------------------------------------------------------------*/
	...
	/**
	 * 
	 * Default List method to list all record of Receipt in the database.
	 * 
	 ...
	 * 
	 * @return ArrayList of Receipt objects matches to the given condition.
	 * 
	 */
...
/*----------------------------------------[ ToCLASSINFO ]-----------------------------------------*/
/*------------------------------------------------------------------------------------------------*/
/*----------------------- Convert Receipt class to the ReceiptInfo class. ------------------------*/
/*------------------------------------------------------------------------------------------------*/
	...
	public ReceiptInfo toReceiptInfo() {
		...
		ci.id = this.id;
		ci.receipt_date = this.receipt_date;
		ci.cost = this.cost;
		ci.total = this.total;
		ci.cash = this.cash;
